...
// Оценивает КБЖУ по текстовому описанию. Пытается несколько раз (сначала с
// принудительным JSON-режимом API, затем с усиленным промптом), и только
// если AI совсем не смог ответить валидным JSON — считает сам через
// fallbackMacroEstimate. Никогда не кидает ошибку наружу и никогда не
// требует ручного ввода от пользователя.
